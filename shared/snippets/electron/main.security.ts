...
// Register IPC handlers in a separate module and call them in app.whenReady().
// Example: import { registerFileIpc } from './ipc/files'
...
export function createWindow(): BrowserWindow {
  const win = new BrowserWindow({
    ...
    webPreferences: {
      ...
      // See boundaries/electron/security-checklist.md for the full rationale.
